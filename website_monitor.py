...
def get_avail_string(driver, url = "https://www.lenovo.com/us/en/laptops/legion-laptops/legion-7-series/Legion-7-16ITH6/p/LEN101G0002"):
    driver.get(url)

    # check if item is temporarily unavailable
    try:
        check_avail = driver.find_element_by_xpath("//*[contains(text(), 'TEMPORARILY UNAVAILABLE')]")
    except NoSuchElementException:
        check_avail = None
    
    return check_avail

def check_cart_button(driver, url = "https://www.lenovo.com/us/en/laptops/legion-laptops/legion-7-series/Legion-7-16ITH6/p/LEN101G0002"):
    driver.get(url)

    l7_cart = driver.find_element_by_xpath('//*[@id="addToCartFormTop82K60004US"]/button')
